...
const PropertyDetailItems = () => {
    ...
    const verifyProperty = async () => {
        try {
            await axios.post('http://localhost:5000/v1/property/update-property-status', {
    ...
    return (
        <Fragment>
            <div className="w-full lg:w-auto m-0  flex flex-col bg-white rounded-3xl  shadow-md my-[100px]">
                <div>
                        ...
                        <div className=" px-1 mt-2 mb-1">
                            ...
                            <div className="flex flex-wrap justify-center my-2">
                                {property.facilities?.map((feature, index) => (
                                    <span
                                        key={index}
                                        className="font-Poppins text-center bg-liteyellow text-[8px] lg:text-[10px] mx-1 p-[2px] my-[2px] lg:my-0 px-2 rounded-full text-white"
                                    >
                                        {feature}
                                    </span>
                                ))}
